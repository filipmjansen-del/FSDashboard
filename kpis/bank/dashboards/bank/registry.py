...
def _discover_dashboards():
    for industry, package_name in INDUSTRY_PACKAGES.items():
        try:
            package = importlib.import_module(f"dashboards.{package_name}")
        ...
        for module_info in pkgutil.iter_modules(package.__path__):
            ...
            INDUSTRY_DASHBOARD_CATALOG[industry].append(dashboard_name)
...
def render_dashboard(raw_data, dashboard_name):
    ...
    DASHBOARD_REGISTRY[dashboard_name]["render"](raw_data)
